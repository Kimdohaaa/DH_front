...
let 재고기록 = [
    { 도서코드 : 1 , 변화량 : 3 , 현재재고량 : 1, 상태 : "입고" , 정가 : 6500 , 입고날짜 : "2024-12-4" },
    { 도서코드 : 1 , 변화량 : -1 , 현재재고량 : 1, 상태 : "출고" , 정가 : 6500 , 입고날짜 : "2024-12-5" },
    { 도서코드 : 3 , 변화량 : 5 , 현재재고량 : 1, 상태 : "출고" , 정가 : 15000 , 입고날짜 : "2024-12-6" }
] // 추적하기 위해서
...
/*
재고기록 내 재고량을 모두 받는 변수 a 
재고 기록 시 상태가 "입고"면 a + 입력재고량
재고 기록 시 상태가 "출고"면 a - 입력재고량
